...
SECRET_KEY = 'c_%_@7j3*-$s1a2qi9+9n069!*@dg9r0$_7+@4cgg9_y!$o^v9'
...
REST_FRAMEWORK = {
	...
	'DEFAULT_AUTHENTICATION_CLASSES': [
		'payments.auth_tokens.authentication.TokenAuth',
...
env = getattr(os.environ,'HOME', '/app')
if '/app' in env:
    import django_heroku
